...
- [Riot Games: Riot's Approach to Anti-Cheat](https://technology.riotgames.com/): Excellent technical deep dives into anti-cheat (Vanguard) and risk-based systems.
...
- [ACM Survey: "A Survey on Adaptive Authentication"](https://dl.acm.org/doi/10.1145/3340744): A foundational academic survey and taxonomy of Risk-Based and adaptive authentication systems.
...
- [The Economy of Botting in MMORPGs](https://mural.maynoothuniversity.ie/2257/): A case study on the financial drivers and ecosystem behind automation in gaming.
...
#### Tools
- [UltimateAntiCheat](https://github.com/mathisvickie/UltimateAntiCheat): A usermode anti-cheat system built in C++ designed to detect common attack vectors like debugging, memory editing, and code injection.
...
- [JS-Confuser](https://github.com/MichaelS11/js-confuser): A powerful open-source obfuscator known for its aggressive transformations and ability to make code highly resilient to static analysis.
...
- [[SeleniumConf 2023] "Python Selenium: Fundamentals to Frameworks (with SeleniumBase)" by Michael Mintz](https://www.youtube.com/watch?v=5dMv9Z7_6_Y): A comprehensive look at the evolution of Selenium, driver management, and how SeleniumBase simplifies complex automation tasks.
